...
#else
LibMeshInit::LibMeshInit (int argc, const char * const * argv, MPI_Comm COMM_WORLD_IN,
                          int n_threads)
#endif
{
  ...
  // Build a task scheduler
  {
    ...
    libMesh::libMeshPrivateData::_n_threads = libMesh::command_line_value(n_threads_opt, n_threads);
